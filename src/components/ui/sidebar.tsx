...
>(
  (
    ...
    // Read sidebar state from cookie on mount, default to open if no cookie exists
...
>(({ className, ...props }, ref) => {
  return (
    <main
      ref={ref}
      className={cn(
        "relative flex min-h-svh flex-1 flex-col bg-background w-full min-w-0 overflow-x-auto overflow-y-auto",
